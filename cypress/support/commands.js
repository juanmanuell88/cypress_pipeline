...
Cypress.Commands.add("Bloque_ToolsQA_Dos", (name, email,dir1,dir2,t) => {
    let tiempo=t
    cy.Texto_visible("#userName",name,t)     
    cy.Texto_visible("#userEmail",email,t) 
    cy.Texto_visible_xpath("//textarea[contains(@id,'currentAddress')]",dir1,t)
    cy.Texto_visible_xpath("//textarea[contains(@id,'permanentAddress')]",dir2,t)
    cy.Click_force_xpath("//button[contains(@id,'submit')]",t)
